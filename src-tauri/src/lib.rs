...
pub fn run() {
    tauri::Builder::default()
        ...
        //Custom API
        .invoke_handler(tauri::generate_handler![list_folder_items, write_file_at_offset, set_last_modified, read_metadata_db, save_metadata_db, server_start, server_send_text, server_send_binary])
...
#[tauri::command]
fn read_metadata_db(db_path: String) -> Result<HashMap<String, MetadataItem>, String> {
...
#[tauri::command]
fn save_metadata_db(db_path: String, updated: HashMap<String, MetadataItem>, deleted: Vec<String>) -> Result<(), String> {
